            ...
            <div class="max-w-md w-full bg-gray-100 shadow-lg rounded-xl p-6">
                <div class="relative">
                    <div x-data="{ open: false }" @mouseleave="open = false" @mouseover="open = true" class="absolute flex flex-col top-0 right-0 p-3">
                        ...
                        <div x-show="open" x-transition:enter.duration.300ms x-transition:leave.duration.300ms class="flex items-center justify-center absolute -right-2 top-10 w-60 mt-2 bg-white rounded-md shadow-xl">
