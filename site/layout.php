  ...
  <nav id="header" class="w-full z-30 top-0 py-1">
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3 bg-white">
      ...
      <div class="order-1 md:order-2 uppercase">
        <a class="flex items-center tracking-wide no-underline hover:no-underline font-bold text-gray-800 text-xl" href="http://localhost:8080/duan1/site/index.php?trang-chu">
      ...
      <div class="order-2 md:order-3 flex items-center space-x-2" id="nav-content">
        ...
        <!-- Cart -->
        <div>
          <a class="inline-block no-underline hover:text-black relative" href="http://localhost:8080/duan1/site/index.php?gio-hang ">
