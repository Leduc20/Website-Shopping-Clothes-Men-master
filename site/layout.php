    ...
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3 bg-white">
      ...
      <div class="order-1 md:order-2 uppercase">
        <a class="flex items-center tracking-wide no-underline hover:no-underline font-bold text-gray-800 text-xl"
          href="http://localhost/fashion/site/index.php?trang-chu">
      ...
      <div class="order-2 md:order-3 flex items-center space-x-2" id="nav-content">
                  ...
                  <div class="flex justify-between items-center mb-2">
                    <a href="" class="w-10/12">
                      <div class="flex space-x-3">
                        ...
                        <div class="w-8/12">
                          <div class="w-full flex-none text-xs flex items-center text-gray-600"></div>
                          <div>
                            <h2
        ...
        <div x-data="{ open: false }" @mouseleave="open = false" @mouseover="open = true" class="relative z-10">
          <a @mouseover="open = true" class="inline-block no-underline hover:text-black" href="#">
            <svg class="fill-current hover:text-black" xmlns="http://www.w3.org/2000/svg" width="32" height="32"
              viewBox="0 0 24 24">
        ...
        <!-- Cart -->
        <div>
          <a class="inline-block no-underline hover:text-black relative" href="http://localhost/fashion/site/index.php?gio-hang ">
            <svg class="fill-current hover:text-black" xmlns="http://www.w3.org/2000/svg" width="34" height="34"
              viewBox="0 0 24 24">
              <path
            ...
            <div class="grid md:grid-cols-3 gird-cols-1 gap-4 flex justify-center items-center">
              ...
              <div class="">
                <input type="text"
                  ...
                  id="exampleFormControlInput1" placeholder="Email của bạn" required />
              </div>

              <div class="md:mr-auto">
                <button type="submit" name="btn-subnews"
                  class="bg-black inline-block px-6 py-2 border-2 border-white text-white font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-60 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
                  Đăng ký
                </button>
              </div>
            </div>
        ...
        <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-5 gap-">
          ...
          <div class="">
            ...
            <p class="flex items-center justify-center md:justify-start">
              <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="print" class="w-4 mr-4" role="img"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="currentColor"
          ...
          <div class="">
            ...
            <p class="mb-4 flex space-x-3">
              ...
              <a href="#!" class="text-gray-600">
                <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin-in" class="w-3.5"
                  role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                  <path fill="currentColor"
