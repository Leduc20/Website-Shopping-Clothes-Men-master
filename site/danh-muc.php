    ...
    <div class="" style="width: 300px;">
        ...
        <div class="mt-2">
            ...
            <form  class=" items-center" method="GET">
                ...
                <button class="w-full my-5 transition ease-in duration-300 inline-flex items-center justify-center text-sm font-medium mb-2 md:mb-0 bg-purple-500 px-4 py-2 hover:shadow-lg tracking-wider text-white rounded-full hover:bg-purple-600" type="submit">Lọc</button>
            </form>
        </div>
    </div>

    <div class="flex-1 ml-4 grid grid-cols-3 lg:grid-cols-4 gap-10 px-4">
...
<div id="toast-fav1" style="transform: translateX(-50%);" class="hidden fixed top-0 left-2/4 -translate-x-2/4 flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
