<form action="" class="">
    ...
    <div class="ml-72 mt-4 mb-8">
        ...
        <a class="bg-blue-500 hover:bg-blue-700 hover:no-underline text-white font-bold py-2 px-4 border border-blue-700 rounded no-underline" href="<?= ADMIN_BASE . "?add-san-pham" ?>">Nhập thêm</a>
    </div>
</form>
