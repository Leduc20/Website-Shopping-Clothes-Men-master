...
?>
<form onsubmit="return checkSelect()" action="index.php?update-pro" method="post" id="checkproduct" enctype="multipart/form-data">
    <div class="grid grid-cols-2 gap-8">
        ...
        <div>
            ...
            <input class="border w-full p-2 rounded-[4px]" type="text" name="name" id="name" value="<?= $name ?>">
        </div>
        <div>
        ...
        <img type="hidden" name="image" src="<?= $image ?>" alt="" name="image">
        <div>
        ...
        <div>
            ...
            <input class="border w-full p-2 rounded-[4px]" type="number" name="description" id="view" value="<?= $description ?>">
        </div>
        <div>
            <p class="font-bold mt-3 mb-2">Date</p>
            <input class="border w-full p-2 rounded-[4px]" type="text" name="date" id="view" value="<?= $date ?>">

        </div>
        <div>
            <p class="font-bold mt-3 mb-2">Date</p>
            <input class="border w-full p-2 rounded-[4px]" type="date" name="date" id="view" value="">
        </div>
        <!-- <div>
