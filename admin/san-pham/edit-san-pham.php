...
<form onsubmit="return checkSelect()" action="<?=ADMIN_BASE?>?update-pro" method="POST" id="checkproduct"
    ...
    <div class="grid grid-cols-2 gap-2 mr-10 bg-gray-50 rounded">
        ...
        <!-- <div>
            ...
            <input class="border w-full p-2 rounded-[4px]" type="text" name="sale" id="sale" value="">
        </div> -->
        <div class="mt-4 ml-4">
        ...
        <!-- <div class="mt-4 ml-4">
            ...
            <input class="border mt-1 px-[50px] py-2 rounded-[4px]" type="text" name="date" id="view" value="">
