<div>
                <form action="index.php?act=addlh" method="post" id="check-line" enctype="multipart/form-data">
                    ...
                    <buttonhref="<?= ADMIN_BASE . "?danh-muc"?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded" type="submit" name="themmoi">
                    Thêm mới
                    </buttonhref=>
