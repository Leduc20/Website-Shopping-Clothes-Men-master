    ...
    <div class="">
        ...
        <form action="">
            ...
            <div class="z-50">
                ...
                <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded no-underline" href="<?= SITE_URL . "?add-danh-muc"?>">Nhập thêm</a>
            </div>
        </form>
    </div>
