                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        foreach ($show_dm as $show) {
                            extract($show);
                            $edit = "index.php?editlh&id_commodities=" . $id_commodities;
                            ...
                            <a href="<?= ADMIN_BASE . "?danh-muc" ?>" class="no-underline text-black px-2 border border-[2px] p2 rounded bg-sky-300 hover:bg-sky-700">delete</a>
                        </td>
                        </tr>';
                        }
                        ?>
